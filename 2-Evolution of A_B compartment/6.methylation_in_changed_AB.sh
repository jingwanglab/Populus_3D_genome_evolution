...
do
   ...
   ln -s /w/00/g/g00/hic/methylation/Pkor/CHG.results ./Pkor.CHG.results;
   ln -s /w/00/g/g00/hic/methylation/Pkor/CHH.results ./Pkor.CHH.results;
   ln -s /w/00/g/g00/hic/methylation/Pkor/CpG.results ./Pkor.CpG.results;
   ln -s /w/00/g/g00/hic/methylation/"$i"/CHG.results ./"$i".CHG.result;
   ln -s /w/00/g/g00/hic/methylation/"$i"/CHH.results ./"$i".CHH.results;
   ln -s /w/00/g/g00/hic/methylation/"$i"/CpG.results ./"$i".CpG.results;
