...
do
   cd /w/00/g/g00/hic/tad.analysis/tad.methylation/
   mkdir "$i"; cd "$i";
   ...
   bedtools makewindows -b "$i".tad.raw.bed -n 20 -i winnum > "$i".tad.20bin.bed;
   ...
   ####CHG
   bedtools intersect -nonamecheck -a CHG.results -b "$i".tad.20bin.bed -wa -wb |awk '{print $4"\t"$10}' > "$i".tad.20bin.chg.bed;
   bedtools intersect -nonamecheck -a CHG.results -b "$i".tadup.50kb.20bin.bed -wa -wb |awk '{print $4"\t"$10}' > "$i".tadup.50kb.20bin.chg.bed;
   bedtools intersect -nonamecheck -a CHG.results -b "$i".taddown.50kb.20bin.bed -wa -wb |awk '{print $4"\t"$10}' > "$i".taddown.50kb.20bin.chg.bed;
   ####CHH
   bedtools intersect -nonamecheck -a CHH.results -b "$i".tad.20bin.bed -wa -wb |awk '{print $4"\t"$10}' > "$i".tad.20bin.chh.bed;
   bedtools intersect -nonamecheck -a CHH.results -b "$i".tadup.50kb.20bin.bed -wa -wb |awk '{print $4"\t"$10}' > "$i".tadup.50kb.20bin.chh.bed;
   bedtools intersect -nonamecheck -a CHH.results -b "$i".taddown.50kb.20bin.bed -wa -wb |awk '{print $4"\t"$10}' > "$i".taddown.50kb.20bin.chh.bed;
   ####CpG
   bedtools intersect -nonamecheck -a CpG.results -b "$i".tad.20bin.bed -wa -wb |awk '{print $4"\t"$10}' > "$i".tad.20bin.cpg.bed;
   bedtools intersect -nonamecheck -a CpG.results -b "$i".tadup.50kb.20bin.bed -wa -wb |awk '{print $4"\t"$10}' > "$i".tadup.50kb.20bin.cpg.bed;
   bedtools intersect -nonamecheck -a CpG.results -b "$i".taddown.50kb.20bin.bed -wa -wb |awk '{print $4"\t"$10}' > "$i".taddown.50kb.20bin.cpg.bed;
